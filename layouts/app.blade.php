...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="{{ Theme::asset('pub_theme::resources/img/apple-icon.png') }}">
  <link rel="icon" type="image/png" href="{{ Theme::asset('pub_theme::resources/img/favicon.png') }}">
  ...
  <!-- CSS Files -->
  <link href="{{ Theme::asset('pub_theme::resources/css/bootstrap.min.css') }}" rel="stylesheet" />
  <link href="{{ Theme::asset('pub_theme::resources/css/now-ui-dashboard.css') }}" rel="stylesheet" />
  <!-- CSS Just for demo purpose, don't include it in your project -->
  <link href="{{ Theme::asset('pub_theme::resources/demo/demo.css') }}" rel="stylesheet" />
  <!-- Google Tag Manager -->
  <script>
...
<body class="{{ $class ?? '' }}">
  ...
  <div class="wrapper">
    @auth
      @include('pub_theme::layouts.page_template.auth')
    @endauth
    @guest
      @include('pub_theme::layouts.page_template.guest')
    @endguest
  </div>
  <!--   Core JS Files   -->
  <script src="{{ Theme::asset('pub_theme::resources/js/core/jquery.min.js') }}"></script>
  <script src="{{ Theme::asset('pub_theme::resources/js/core/popper.min.js') }}"></script>
  <script src="{{ Theme::asset('pub_theme::resources/js/core/bootstrap.min.js') }}"></script>
  <script src="{{ Theme::asset('pub_theme::resources/js/plugins/perfect-scrollbar.jquery.min.js') }}"></script>
  <!--  Google Maps Plugin    -->
  <script src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script>
  <!-- Chart JS -->
  <script src="{{ Theme::asset('pub_theme::resources/js/plugins/chartjs.min.js') }}"></script>
  <!--  Notifications Plugin    -->
  <script src="{{ Theme::asset('pub_theme::resources/js/plugins/bootstrap-notify.js') }}"></script>
  <!-- Control Center for Now Ui Dashboard: parallax effects, scripts for the example pages etc -->
  <script src="{{ Theme::asset('pub_theme::resources/js/now-ui-dashboard.min.js') }}" type="text/javascript"></script>
  <!-- Now Ui Dashboard DEMO methods, don't include it in your project! -->
  <script src="{{ Theme::asset('pub_theme::resources/demo/demo.js') }}"></script>
  @stack('js')
</body>
